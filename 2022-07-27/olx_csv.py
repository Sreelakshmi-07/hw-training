...
def response(item_data):
        ...
        bathroom = item_data.xpath("//div[@data-aut-id='itemParams']/div/div/div/span[@data-aut-id='key_bathrooms']/following-sibling::span[@data-aut-id='value_bathrooms']/text()"
                                                    ).get()
        if bathroom is None:
        ...
        bedroom = item_data.xpath("//div[@data-aut-id='itemParams']/div/div/div/span[@data-aut-id='key_rooms']/following-sibling::span[@data-aut-id='value_rooms']/text()"
                                                    ).get() 
        if bedroom is None:
        ...
        filename = f"olx_properties2.csv"
