...
#             '//div[@class="mdl-cell mdl-cell--12-col"]/p/text()\
#                         | //div[@class="mdl-cell mdl-cell--12-col"]//span//text()'
#         ).extract()
#         description = ''.join(
#             description_xpath).encode('ascii','ignore').strip() if description_xpath else ''
